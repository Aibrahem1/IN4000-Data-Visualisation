...
ggplot(data_1990, aes(x = reorder(Sector, -Emissions), y = Emissions, fill = Sector)) +
...
ggplot(GHG_data_long, aes(x = year, y = Emissions, fill = Sector)) +
  geom_area(position = "stack") +
  labs(title = "Emissions by Sector Over Time", x = "Year", y = "Total Emissions") +
  theme_minimal() +
